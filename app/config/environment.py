...
class EnvironmentConfig:
    ...
    def _apply_server_config(self):
        ...
        os.environ.setdefault('DATABASE_URL', 
            'mssql+pyodbc://sqlvendor1:1U~xO%602Un-gGqmPj@10.182.128.3:1433/dbvendor?driver=ODBC+Driver+17+for+SQL+Server')
    ...
    def _apply_local_config(self):
        ...
        os.environ.setdefault('DATABASE_URL', 
            'mssql+pyodbc://sqlvendor1:1U~xO%602Un-gGqmPj@127.0.0.1:1435/dbvendor?driver=ODBC+Driver+17+for+SQL+Server')
        os.environ.setdefault('SOURCE_DATABASE_URL', 
            'mssql+pyodbc://sqlvendor1:1U~xO%602Un-gGqmPj@127.0.0.1:1435/dbvendor?driver=ODBC+Driver+17+for+SQL+Server')
